...
export default function Avalanche() {
    return (
        ...
        <div class = "text-center bg-zinc-300 py-8 px-8 space-y-5">
            ...
            <h1 class = "text-5xl font-bold text-center">Avalanche hotspot</h1>

            <div class = " py-10">
            
                <img class = " h-200 w-200 " src="https://az705044.vo.msecnd.net/20210608/bitcoin-chart.png"></img>
            ...
            <div class = "text-center bg-zinc-200 max-w-sm mx-auto py-10 space-y-5 rounded-xl shadow-lg items-center">
                ...
                <div class = "bg-zinc-100 rounded-xl shadow-lg items-center">
                    <label>Teacher: </label>
                    <label>I want to teach yo all i know about Avalanche Coin!!</label>
                </div>
                <div class = "bg-zinc-100 rounded-xl shadow-lg items-center">
                    <label>Student: </label>
